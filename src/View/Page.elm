                                ...
                                (navLinks
                                    ++ [ li []
                                            ...
                                            , ul [ class "dropdown-menu developers" ]
                                                [ div [ class "row" ]
                                                    [ div [ class "col-sm-12" ]
                                                        [ h3 [] [ a [ href "http://docs.nexosis.com" ] [ text "Documentation" ] ] ]
                                                    , div [ class "col-sm-6" ]
                                                        [ p [] [ a [ href "http://docs.nexosis.com/guides/quickstartguide" ] [ text "Quickstart ", i [ class "fa fa-angle-right" ] [] ] ]
                                                        , p [] [ a [ href "http://docs.nexosis.com/guides/" ] [ text "Guides ", i [ class "fa fa-angle-right" ] [] ] ]
                                                        , p [] [ a [ href "http://docs.nexosis.com/tutorials/" ] [ text "Tutorials ", i [ class "fa fa-angle-right" ] [] ] ]
                                                        , p [] [ a [ href "http://docs.nexosis.com/clients/" ] [ text "API Clients ", i [ class "fa fa-angle-right" ] [] ] ]
