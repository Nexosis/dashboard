port module Ports exposing (copy, drawVegaChart, fileContentRead, fileSaved, log, objectRetrieved, prismHighlight, requestSaveFile, requestSent, responseReceived, retrieveObject, storeObject, uploadFileSelected)
